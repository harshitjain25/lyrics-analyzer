...
Figure~\ref{fig:home} shows the deployed dashboard home page, confirming the corpus statistics: 3,020 songs, 6 genres, 7 decades, and 8 topics.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{01_home.png}
\caption{Dashboard home page showing corpus overview, songs per decade, and songs per genre.}
\label{fig:home}
\end{figure}

\subsection{Topic Distribution}

Table~\ref{tab:topics} shows the distribution of songs across the eight discovered topics. Figure~\ref{fig:themes} illustrates the theme distribution by decade and the genre $\times$ theme heatmap. Heartbreak and Loss is the dominant theme (46.9\%), consistent with prior computational analysis showing that song lyrics are predominantly concerned with romantic themes \citep{fell2014lyrics}. Love and Romance accounts for a further 24.5\%, together suggesting that approximately 71\% of popular song lyrics centre on romantic experience. Social Issues and Protest (1.5\%) and Faith and Spirituality (1.1\%) are the least represented themes.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{02_theme_explorer.png}
\caption{Theme Explorer: (left) stacked bar chart showing theme distribution across decades; (right) genre $\times$ theme heatmap with topic keywords.}
\label{fig:themes}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{03_sentiment_trends.png}
\caption{Average sentiment score by genre across decades (1960s--2020s). Electronic music shows the steepest decline; R\&B is consistently the most positive genre.}
\label{fig:sentiment}
\end{figure}
...
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{04_genre_comparison.png}
    \caption{Genres ranked by sentiment (left) and emotion profile heatmap by genre (right).}
    \label{fig:genre_comparison}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{05_emotion_radar.png}
    \caption{Emotion radar comparing pop vs.\ rock, and emotion mix over decades.}
    \label{fig:emotion_radar}
\end{subfigure}
\caption{Genre Comparison page: sentiment and emotion profiles across genres and decades.}
\label{fig:genre_emotion}
\end{figure}
...
\centering
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{06_song_search.png}
    \caption{Semantic Song Search: top-10 results for the query \textit{``romance''}.}
    \label{fig:search}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{07_song_explainer.png}
    \caption{AI Song Explainer: emotion scores and LLM-generated analysis for \textit{FEIN} by Travis Scott.}
    \label{fig:explainer}
\end{subfigure}
\caption{Interactive features: semantic search and LLM-assisted song explanation.}
...
All team members contributed to integration, testing, and report writing.
