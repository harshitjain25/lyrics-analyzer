...
\affil*[1]{\orgname{NLP Course Project}, \orgaddress{\city{Atlanta}, \state{Georgia}, \country{USA}}}
...
\begin{tabular*}{\textwidth}{@{\extracolsep\fill}lrrrrrrr|r}
\toprule
...
\begin{tabular*}{\textwidth}{@{\extracolsep\fill}p{4cm}p{9cm}}
\toprule
